...
dataroot_amass ="/local_datasets/amass" # root of amass dataset
target_datasets=  ["KIT"] #"MPI_HDM05", "BioMotionLab_NTroje", "CMU",
for dataroot_subset in target_datasets:
    ...
    for phase in ["train","test"]:
        ...
        for filepath in tqdm(filepaths):
            data = dict()
            bdata = np.load(os.path.join(dataroot_amass,filepath),allow_pickle=True)
